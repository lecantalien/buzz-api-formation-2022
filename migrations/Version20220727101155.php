 ...
 */
final class Version20220727101155 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE game CHANGE promotion promotion DOUBLE PRECISION DEFAULT NULL, CHANGE date_release date_release DATETIME DEFAULT NULL');
    }
